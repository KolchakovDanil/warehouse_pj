...
from warehouse.views import (
    index, products_page, categories_page, employees_page, positions_page,
    ProductList, CategoryList, EmployeeList, PositionList,
    ProductDetail, CategoryDetail, EmployeeDetail, PositionDetail
)
